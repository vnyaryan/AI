...
#  variables
log_directory = r'C:\Users\ARYAVIN\Documents\GitHub\BOT\UDEMY_PROJECT-2\4'
log_filename = 'langchain.log'
api_key = "sk-proj-T1RLCxGczTeaypvM6WkuT3BlbkFJ6sf0MnB4MJr3PyCxQhOJ"
file_path = r"C:\Users\ARYAVIN\Documents\GitHub\BOT\UDEMY_PROJECT-2\4\facts\facts.txt"
chunk_file_path = r"C:\Users\ARYAVIN\Documents\GitHub\BOT\UDEMY_PROJECT-2\4\facts\chunk.txt"
chroma_collection_name = "1st_embeddings" 
persist_directory = r'C:\Users\ARYAVIN\Documents\GitHub\BOT\UDEMY_PROJECT-2\4\chroma_persist' 
query = "tell me about shrimp" 
...
def perform_similarity_search(query, vector_store, embeddings_model):
    ...
    try:
        ...
        for result in results:
            logging.info(f"Found document: {result.page_content} with score {result.score}")
        return results
    except Exception as e:
